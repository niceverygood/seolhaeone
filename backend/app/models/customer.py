...
class Customer(Base):
    ...
    grade: Mapped[str] = mapped_column(String(20), default="member")  # diamond, gold, silver, member
    clv: Mapped[int] = mapped_column(Numeric(12, 0), default=0)
    churn_risk: Mapped[float] = mapped_column(Numeric(3, 2), default=0)
